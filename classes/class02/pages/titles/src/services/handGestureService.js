...
export default class HandGestureServices {
    #gestureEstimator
    #handPoseDetection
    #handsVersion
    #detector = null
    ...
    async initializeDetector() {
        ...
        this.#detector = await this.#handPoseDetection.createDetector(this.#handPoseDetection.SupportedModels.MediaPipeHands,
            detectorConfig
        );
